                ...
                <form method="post">
                    <div class="row">
                       <div class="col-md-1"></div>
                        <div class="col-md-7">
                            <input class="form-control form-control-lg form-control-borderless" type="search" placeholder="Tìm kiếm tên phim, đạo diễn, diễn viên, ..." name="qry">
                        </div>
                        <div class="col-md-4">
                    ...
                    <?php
                        if(isset($_POST["button_search"])){
                            ...
                            if (mysqli_num_rows($result) > 0) { ?>
                                ...
                                echo " Dữ liệu không phù hợp: ".$qry;
                            }
                        }
                            mysqli_close($link);
                    ?>
