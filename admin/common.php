	...
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="navbar-header">
			<button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-ex1-collapse">
				<span class="sr-only">Chuyển đổi bảng điều hướng</span>
		...
		<div class="collapse navbar-collapse navbar-ex1-collapse">
			<ul id="active" class="nav navbar-nav side-nav">
				<li>
					<a href="index.php">
						<i class="fa fa-bullseye"></i> Bảng điều khiển </a>
				</li>
				<li>
					<a href="addFilm.php">
				...
				<li>
					...
					<i class="fa fa-plus"></i></i> Thêm tập phim</a>
				</li>
				<li>
			...
			<ul class="nav navbar-nav navbar-right navbar-user">
				...
				<li class="dropdown user-dropdown">
					...
					<ul class="dropdown-menu">
						<li>
							<a href="<?php echo "editUser.php?id=". $rowAd["ID"]?>"> <i class="fa fa-user"></i> Thông tin</a>
						</li>
						<li>
